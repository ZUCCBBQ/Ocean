...
class ComputionalPhysicsCrawler(QObject):
	...
	def obtain_info(self):
		...
		out=open(self.abspath + "/../data/journal_total/Computional_Physics.csv",'w',newline='', encoding='UTF-8')
		...
		for i in range(9,len(Article_sort)):
			...
			if num % 5 == 0:
				...
				pass
			self.get(inurl,HEADERS,csv_write,out,proxies3)
			time.sleep(0.5)
		print('over')
		out.close()
