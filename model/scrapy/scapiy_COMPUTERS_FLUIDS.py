...
if __name__ == '__main__':
	...
	out=open("/home/cbq/Desktop/scapiy/Computers_Fluids.csv",'a',newline='')
	...
	#		pass
	#	print(proxies2)
	Volume_req = requests.get('https://www.sciencedirect.com/journal/computers-and-fluids/vol/39/issue/1', headers=HEADERS,proxies=proxies2)
