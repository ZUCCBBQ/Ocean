...
if __name__ == '__main__':
	...
	out=open("/home/cbq/Desktop/scapiy/Engineering_Structures.csv",'a',newline='')
	...
	for i in range(33,32,-1):
		for j in range(2,13):
			...
			if count % 5 == 0:
				...
				pass
			print(proxies2)
			Volume_req = requests.get('https://www.sciencedirect.com/journal/engineering-structures/vol/{0}/issue/{1}'.format(i,j), headers=HEADERS,proxies=proxies2)
