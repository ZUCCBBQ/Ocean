...
input_file_big = open("../data/journal_year/AICHE_JOURNAL_2018.csv",'r',encoding='utf-8',errors='ignore').readlines()
# 转大小写
...
with open('../data/lda_topic/AICHE_JOURNAL_2018lda.txt', 'w', newline='',encoding='UTF-8') as f:
