...
if __name__ == '__main__':
	...
	out=open("/home/cbq/Desktop/scapiy/NUMERICAL_METHODS.csv",'a',newline='')
	...
	count = 0
	proxies2 = get_ip()
	for i in range (76,73,-1):
		for j in range(1,13):
			count = count+1
			firstone = 'https://onlinelibrary.wiley.com/toc/10970363/2014/{0}/{1}'.format(i,j)
			if count % 5 == 0:
				proxies2 = get_ip()
			else:
				pass
