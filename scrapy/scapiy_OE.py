...
if __name__ == '__main__':
	...
	out=open("/home/cbq/Desktop/scapiy/OceanEngineering3.csv",'a',newline='')
	csv_write=csv.writer(out,dialect='excel')
	Article_sort = []
	# 37
	for i in range(48,37,-1):
		proxies2 = get_ip()
		print(proxies2)
		Volume_req = requests.get('https://www.sciencedirect.com/journal/ocean-engineering/vol/{0}/suppl/C'.format(i), headers=HEADERS,proxies=proxies2)
